...
// Limits specific to AK10-9 servo
#define P_MIN -12.5f
#define P_MAX 12.5f
#define V_MIN -46.57f
#define V_MAX 46.57f
...
float p_in = 0.;  // desired position
float v_in = 0.;  // desired velocity
float t_in = 0.;  // desired torque
float kp_in = 0.; // desired proportional
float kd_in = 0.; // desired derivative
